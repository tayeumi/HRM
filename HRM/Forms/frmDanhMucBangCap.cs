...
namespace HRM.Forms
{
    public partial class frmDanhMucBangCap : DevExpress.XtraEditors.XtraForm
    {
        public frmDanhMucBangCap()
        {
            InitializeComponent();
        }       

        private void frmDanhMucBangCap_Load(object sender, EventArgs e)
        {
            GetAllList_DEGREE();
        ...
        public void GetAllList_DEGREE()
        {
            Class.DanhMuc_BangCap dm = new Class.DanhMuc_BangCap();
            gridItem.DataSource = dm.GetAllList_DIC_DEGREE();
        }

        private void btnAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            frmDanhMuc_Update frm = new frmDanhMuc_Update(true, "Thêm Bằng cấp", "BC", null,"frmDanhMucBangCap");
            frm.Owner = this;
            frm.ShowDialog();
        }
        ...
        private void btnEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (SelectedRow >= 0)
            {
                ...
                frmDanhMuc_Update frm = new frmDanhMuc_Update(false, "Sửa Bằng cấp", "BC", _value,"frmDanhMucBangCap");
                frm.Owner = this;
                frm.ShowDialog();
            }
        }
