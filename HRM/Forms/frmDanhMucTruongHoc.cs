...
namespace HRM.Forms
{
    public partial class frmDanhMucTruongHoc : DevExpress.XtraEditors.XtraForm
    {
        public frmDanhMucTruongHoc()
        {
            InitializeComponent();
        }

        private void frmDanhMucTruongHoc_Load(object sender, EventArgs e)
        {
            GetAllList_SCHOOL();
        ...
        public void GetAllList_SCHOOL()
        {
            Class.DanhMuc_TruongHoc dm = new Class.DanhMuc_TruongHoc();
            gridItem.DataSource = dm.GetAllList_SCHOOL();
        }

        private void btnAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            frmDanhMuc_Update frm = new frmDanhMuc_Update(true, "Thêm Trường học", "TrH", null, "frmDanhMucTruongHoc");
            frm.Owner = this;
            frm.ShowDialog();
        }
        ...
        private void btnEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (SelectedRow >= 0)
            {
                ...
                string _value = drow["SchoolCode"].ToString();

                frmDanhMuc_Update frm = new frmDanhMuc_Update(false, "Cập nhật trường học", "TrH", _value, "frmDanhMucTruongHoc");
                frm.Owner = this;
                frm.ShowDialog();
            }
        }
