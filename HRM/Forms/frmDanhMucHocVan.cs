...
namespace HRM.Forms
{
    public partial class frmDanhMucHocVan : DevExpress.XtraEditors.XtraForm
    {
        public frmDanhMucHocVan()
        {
            InitializeComponent();
        }

        private void frmDanhMucHocVan_Load(object sender, EventArgs e)
        {
            GetAllList_EDUCATION();
        ...
        public void GetAllList_EDUCATION()
        {
            Class.DanhMuc_HocVan dm = new Class.DanhMuc_HocVan();
            gridItem.DataSource = dm.GetAllList_EDUCATION();
        }

        private void btnAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            frmDanhMuc_Update frm = new frmDanhMuc_Update(true, "Thêm Học vấn", "HV", null,"frmDanhMucHocVan");
            frm.Owner = this;
            frm.ShowDialog();
        }
        ...
        private void btnEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (SelectedRow >= 0)
            {
                ...
                frmDanhMuc_Update frm = new frmDanhMuc_Update(false, "Sửa Học vấn", "HV", _value,"frmDanhMucHocVan");
                frm.Owner = this;
                frm.ShowDialog();
            }
        }
