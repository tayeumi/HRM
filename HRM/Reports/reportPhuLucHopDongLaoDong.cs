...
{
    public partial class reportPhuLucHopDongLaoDong : DevExpress.XtraReports.UI.XtraReport
    {
        public reportPhuLucHopDongLaoDong()
        {
            InitializeComponent();
        }

        public reportPhuLucHopDongLaoDong(DataTable dt)
        {
            InitializeComponent();
        ...
        private void reportPhuLucHopDongLaoDong_PrintProgress(object sender, DevExpress.XtraPrinting.PrintProgressEventArgs e)
        {
            try
            {
