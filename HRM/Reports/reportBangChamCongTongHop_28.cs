...
{
    public partial class reportBangChamCongTongHop_28 : DevExpress.XtraReports.UI.XtraReport
    {
        public reportBangChamCongTongHop_28()
        {
            InitializeComponent();
        }
         public reportBangChamCongTongHop_28(int thang,int nam,string Loai)
        {
            InitializeComponent();
