...
{
    public partial class reportThuMoiLamViec : DevExpress.XtraReports.UI.XtraReport
    {
        public reportThuMoiLamViec(decimal totalSalary, decimal totalTestSalary)
        {
            InitializeComponent();
        ...
        private void reportThuMoiLamViec_PrintProgress(object sender, DevExpress.XtraPrinting.PrintProgressEventArgs e)
        {
            try
            {
