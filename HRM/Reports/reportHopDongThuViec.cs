...
{
    public partial class reportHopDongThuViec : DevExpress.XtraReports.UI.XtraReport
    {
        public reportHopDongThuViec()
        {
            InitializeComponent();           
            
        }
        public reportHopDongThuViec(DataTable dt,decimal totalSalary,decimal totalTestSalary)
        {
            InitializeComponent();
        ...
        private void reportHopDongThuViec_PrintProgress(object sender, DevExpress.XtraPrinting.PrintProgressEventArgs e)
        {
            try
            {
