...
{
    public partial class ReportThoaThuanThoiViec : DevExpress.XtraReports.UI.XtraReport
    {
        public ReportThoaThuanThoiViec()
        {
            InitializeComponent();
        }
         public ReportThoaThuanThoiViec(string BoPhan, string Sex, string FullName,string CanCuNoiDung,string SoHopDongHienTai, string NgayKy, string SoBaoHiem)
        {
            InitializeComponent();
           ...
           // lblFulName4.Text = FullName + lblFulName4.Text;
            lblCanCu.Text = "Xét thỏa thuận thôi viêc giữa công ty TNHH Phú Thế Hưng và " + CanCuNoiDung +";";
