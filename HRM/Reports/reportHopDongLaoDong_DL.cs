...
{
    public partial class reportHopDongLaoDong_DL : DevExpress.XtraReports.UI.XtraReport
    {
        public reportHopDongLaoDong_DL()
        {
            InitializeComponent();

        }
        public reportHopDongLaoDong_DL(DataTable dt)
        {
            InitializeComponent();
        ...
        private void reportHopDongLaoDong_DL_PrintProgress(object sender, DevExpress.XtraPrinting.PrintProgressEventArgs e)
        {
            try
             {
