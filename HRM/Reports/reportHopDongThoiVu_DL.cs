...
{
    public partial class reportHopDongThoiVu_DL : DevExpress.XtraReports.UI.XtraReport
    {
        public reportHopDongThoiVu_DL()
        {
            InitializeComponent();
        }

        private void reportHopDongThoiVu_DL_PrintProgress(object sender, DevExpress.XtraPrinting.PrintProgressEventArgs e)
        {
            try
            {
