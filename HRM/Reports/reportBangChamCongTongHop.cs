...
{
    public partial class reportBangChamCongTongHop : DevExpress.XtraReports.UI.XtraReport
    {
        public reportBangChamCongTongHop()
        {
            InitializeComponent();
        }
        public reportBangChamCongTongHop(int thang,int nam,string Loai)
        {
            InitializeComponent();
                ...
                if (txt.Equals("Sunday"))
                {
                    switch (list.Count)
                    {
                        ...
                        case 30:
                            ...
                            break;
                        case 31:
                            D31.BackColor = System.Drawing.Color.LightGray;
                            colD31.BackColor = System.Drawing.Color.LightGray;
                            break;
                    }
                }
                #endregion
