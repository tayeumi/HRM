...
{
    public partial class reportBangChamCongTongHop_29 : DevExpress.XtraReports.UI.XtraReport
    {
        public reportBangChamCongTongHop_29()
        {
            InitializeComponent();
        }
         public reportBangChamCongTongHop_29(int thang,int nam,string Loai)
        {
            InitializeComponent();
